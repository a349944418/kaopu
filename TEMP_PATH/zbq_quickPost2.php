...
<form method="post" action="http://localhost/kaopu/index.php?app=weiba&mod=Index&act=doPost" onkeydown="if(event.keyCode==13){return false;}" name="weibaPost" id="weibaPost">
    ...
    <div style="text-align:right"><span style="float:left"><a href="http://localhost/kaopu/index.php?app=weiba&mod=Index&act=post&pt=2">高级模式</a></span><a href="javascript:;" onclick="close_Modal()">取消</a> &nbsp;&nbsp; <a href="javascript:;" class="btn btn-danger" style="background-color:#FC5241;color:white;" onclick="return weibaPost_submit_check(ue)">发布</a></div>
</form>
